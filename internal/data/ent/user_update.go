...
func (uu *UserUpdate) SetIsRoot(s string) *UserUpdate {
	uu.mutation.SetIsRoot(s)
	return uu
}

// SetNillableIsRoot sets the "is_root" field if the given value is not nil.
func (uu *UserUpdate) SetNillableIsRoot(s *string) *UserUpdate {
	if s != nil {
		uu.SetIsRoot(*s)
	}
	return uu
...
// SetIsRoot sets the "is_root" field.
func (uuo *UserUpdateOne) SetIsRoot(s string) *UserUpdateOne {
	uuo.mutation.SetIsRoot(s)
	return uuo
}

// SetNillableIsRoot sets the "is_root" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableIsRoot(s *string) *UserUpdateOne {
	if s != nil {
		uuo.SetIsRoot(*s)
	}
	return uuo
