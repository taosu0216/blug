...
func IsRootEQ(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldIsRoot, v))
}

// IsRootNEQ applies the NEQ predicate on the "is_root" field.
func IsRootNEQ(v string) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldIsRoot, v))
}

// IsRootIn applies the In predicate on the "is_root" field.
func IsRootIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldIn(FieldIsRoot, vs...))
}

// IsRootNotIn applies the NotIn predicate on the "is_root" field.
func IsRootNotIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldIsRoot, vs...))
}

// IsRootGT applies the GT predicate on the "is_root" field.
func IsRootGT(v string) predicate.User {
	return predicate.User(sql.FieldGT(FieldIsRoot, v))
}

// IsRootGTE applies the GTE predicate on the "is_root" field.
func IsRootGTE(v string) predicate.User {
	return predicate.User(sql.FieldGTE(FieldIsRoot, v))
}

// IsRootLT applies the LT predicate on the "is_root" field.
func IsRootLT(v string) predicate.User {
	return predicate.User(sql.FieldLT(FieldIsRoot, v))
}

// IsRootLTE applies the LTE predicate on the "is_root" field.
func IsRootLTE(v string) predicate.User {
	return predicate.User(sql.FieldLTE(FieldIsRoot, v))
}

// IsRootContains applies the Contains predicate on the "is_root" field.
func IsRootContains(v string) predicate.User {
	return predicate.User(sql.FieldContains(FieldIsRoot, v))
}

// IsRootHasPrefix applies the HasPrefix predicate on the "is_root" field.
func IsRootHasPrefix(v string) predicate.User {
	return predicate.User(sql.FieldHasPrefix(FieldIsRoot, v))
}

// IsRootHasSuffix applies the HasSuffix predicate on the "is_root" field.
func IsRootHasSuffix(v string) predicate.User {
	return predicate.User(sql.FieldHasSuffix(FieldIsRoot, v))
}

// IsRootEqualFold applies the EqualFold predicate on the "is_root" field.
func IsRootEqualFold(v string) predicate.User {
	return predicate.User(sql.FieldEqualFold(FieldIsRoot, v))
}
